...
#data directories
data_dir = "/home/fmahnken/PycharmProjects/data/2023-08-11"
...
calibrated_lights = [CCDData.read(calibrated_lights[i], unit='adu')for i in range(19)]
#print(calibrated_darks)
...
# löschen der datein zum korrigieren am ende
